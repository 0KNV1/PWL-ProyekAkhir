      ...
      <div class="container">
        <div class="row px-0 mx-0 kolom">
          <div class="col-lg-6 col-md-5 d-flex justify-content-end img">
            <img src="../../assets/img/Taro.jpg" alt="EsKopiSusu" width="280px" height="500px" />
          </div>
          <div class="col-lg-5 col-md-6 pt-5">
            <div class="row">
              <div class="col-lg-8 col-md-9 col-sm-2">
                <h2 class="judul">Taro Latte</h2>
              </div>
            ...
            <p class="mt-4 pe-lg-5 desc">Minuman Taro adalah minuman yang dibuat dari bubuk Taro, dan susu segar. Taro terbuat dari ekstrak buah talas. Memiliki rasa manis dari buah talas yang berpadu dengan rasa gurih dari susu segar.</p>
